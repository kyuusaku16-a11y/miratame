...
//   フィールド名は互換のため変更しない
// - nobashi（旧・ごきげんルール）は2026-07-11に表示を廃止（アドバイスは descriptions.js ④に集約）。
//   データは将来の再利用（「今日のひとこと」等）のため残している。書く場合は提案の口調・金額推奨や銘柄名なし
...
const TYPES = {
  CGSF: {
    ...
    nobashi: '貯金と同じように「今月使っていいお金」も先に決めておく。予算にした楽しみは、罪悪感ゼロで使えます。',
  },
  CGSN: {
    name: '実りわけのリス',
    emoji: '🐿️',
    ...
    nobashi: '口座とポイントの一覧を、メモ1枚にまとめておく。月に一度ながめれば、忘れてたお金を掘り当てる楽しみつき。',
  },
  CGLF: {
    name: '風にのるワシ',
    emoji: '🦅',
    ...
    nobashi: '生活費の数ヶ月分だけ、すぐ引き出せる現金で持っておく。とまり木があるほど、高く飛べます。',
  },
  CGLN: {
    name: '好奇心のキツネ',
    emoji: '🦊',
    ...
    nobashi: '無料おためしに登録した日に、終了日をスマホのカレンダーへ。未来の自分へのプレゼントです。',
  },
  CMSF: {
    name: '石橋をわたるカメ',
    emoji: '🐢',
    ...
    nobashi: '「いつまで調べるか」を先に決めておく。期限が来たら、見送りだって立派な結論です。',
  },
  CMSN: {
    name: '冬支度のクマ',
    emoji: '🐻',
    ...
    nobashi: '口座を「すぐ使う用」と「当分使わない用」の2つに分けてみる。巣穴は2つあると安心です。',
  },
  CMLF: {
    name: 'はたらきもののアリ',
    emoji: '🐜',
    ...
    nobashi: '積立に「何のため・いつまで」の名前をつけてあげる。あとは半年に一度、名前を見返すだけでOK。',
  },
  CMLN: {
    name: 'しなやかなネコ',
    emoji: '🐈',
    ...
    nobashi: '自動の貯金設定や固定費の見直しみたいな「一度やれば終わること」だけ、元気な日に。あとは寝ていて大丈夫。',
  },
  YGSF: {
    name: '波間のイルカ',
    emoji: '🐬',
    ...
    nobashi: '月に一度、カードの明細を見る日だけ決めておく。現在地がわかれば、また安心して遊べます。',
  },
  YGSN: {
    name: 'おおらかなゾウ',
    emoji: '🐘',
    ...
    nobashi: '誕生月に、サブスクと固定費をまとめて見直す。年に一度で十分です、ゾウの歩幅なら。',
  },
  YGLF: {
    name: '波乗りのペンギン',
    emoji: '🐧',
    ...
    nobashi: '手取り1〜2ヶ月分の「すぐ使える貯金」を先に育てる。戻る場所があるほど、挑戦は深くできます。',
  },
  YGLN: {
    name: '自由なカモメ',
    emoji: '🐦',
    ...
    nobashi: '月末に残高画面を1枚スクショするだけ。家計簿の代わりは、それで十分です。',
  },
  YMSF: {
    name: '見守りのフクロウ',
    emoji: '🦉',
    ...
    nobashi: '調べ物には「いつまでに決めるか」の締め切りをつける。見極めたあなたの判断は、外れません。',
  },
  YMSN: {
    name: 'あったかコアラ',
    emoji: '🐨',
    ...
    nobashi: '年に一度だけ、スマホ料金や保険のプランを見比べてみる。乗り換えるかは、見てから決めればOK。',
  },
  YMLF: {
    name: '芽吹きのヒヨコ',
    emoji: '🐥',
    ...
    nobashi: '人の数字とは比べない。カレンダーの「積立が続いた月」に丸をつけて、昨日の自分とだけ比べる。',
  },
  YMLN: {
    name: 'ひなたのカピバラ',
    emoji: '🦦',
    ...
    nobashi: '給料日に自動でお金が貯金へ移る設定を、ひとつだけ作る。あとは仕組みが働くので、のんびりしていてOK。',
  },
};
