...
const TYPES = {
  ...
  CGSN: {
    ...
    tsuyomi: 'どんぐりは冬のぶんも今日のぶんも、頬袋にちゃんと両方入っている。森でも指折りの詰め方上手です。',
  ...
  CGLF: {
    ...
    tsuyomi: '羽ばたかずに、上昇気流へすっと翼を預けてぐんと高くへ。空でいちばん燃費のいい飛び方です。',
  ...
  YMLF: {
    ...
    tsuyomi: 'いちばん固い殻は、もう自分の嘴で割ってきたあと。生まれた時点で、大仕事をひとつ終えています。',
